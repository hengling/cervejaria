...
public class DecrementarEstoqueCervejaUseCaseTest {
    private final DecrementarEstoqueCervejaOutputDataMapper outputDataMapper = DecrementarEstoqueCervejaOutputDataMapper.INSTANCE;
    ...
    void inicializarUseCase() {
        useCase = new DecrementarEstoqueCervejaUseCaseImpl(cervejaDataProvider, outputDataMapper);
    }

    @Test
    public void quandoInformarDadosCorretamenteDeveDecrementarOEstoque() {
        // given
        ...
        final var outputDataEsperado = DecrementarEstoqueCervejaOutputData.builder()
                .id(1L)
                .nome("Brahma")
                .marca("Ambev")
                .max(50)
    ...
    @Test
    public void quandoQuantidadeEstoqueFicarMenorQueZeroDeveLancarErro() {
        // given
        final Cerveja cerveja = Cerveja.builder()
                .id(1L)
                .nome("Brahma")
        ...
        // then
        assertThrows(EstoqueNegativoException.class, () -> useCase.execute(inputData));
    }
}
